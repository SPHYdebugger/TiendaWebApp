    ...
    <div class="container" style="margin-top: 100px;">
        ...
        <% for (Client client : (List<Client>)request.getAttribute("clients")) { %>
            <tr>
                ...
                <td><a href="detailsClientUser.jsp?id=<%= client.getId_client()%>&user_name=<%= request.getParameter("user_name") %>" class="btn btn-sm btn-outline-secondary">VER DETALLES</a></td>
            </tr>
        <% } %>
        <div class="container  d-flex justify-content-center">
                <a href="clientsUser.jsp?user_name=<%= request.getParameter("user_name") %>" type="button" class="btn btn-primary col-4" style="margin-top: 30px; margin-bottom: 30px;">Volver a la lista de clientes</a>
        </div>
