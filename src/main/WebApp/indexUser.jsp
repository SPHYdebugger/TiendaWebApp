      ...
      <div class="container marketing">
        ...
        <div class="row" style="text-align: center; margin-top: 30px; margin-bottom: 30px;">
          <div class="col-lg-4">
            ...
            <p><a class="btn btn-secondary" href="clientsUser.jsp" role="button">ENTRAR &raquo;</a></p>
          </div><!-- /.col-lg-4 -->
          <div class="col-lg-4">
            ...
            <p><a class="btn btn-secondary" href="productsUser.jsp" role="button">ENTRAR &raquo;</a></p>
          </div><!-- /.col-lg-4 -->
          <div class="col-lg-4">
            ...
            <p><a class="btn btn-secondary" href="buysUser.jsp" role="button">ENTRAR &raquo;</a></p>
          </div><!-- /.col-lg-4 -->
        </div><!-- /.row -->
