...
<div class="container" style="margin-top: 100px;">
        ...
        <% for (Product product : (List<Product>)request.getAttribute("products")) { %>
            <tr>
                ...
                <td><a href="detailsProductUser.jsp?id=<%= product.getId_product()%>&user_name=<%= request.getParameter("user_name") %>" class="btn btn-sm btn-outline-secondary">VER DETALLES</a></td>
            </tr>
        <% } %>
    ...
    <div class="container  d-flex justify-content-center">
                <a href="productsUser.jsp?user_name=<%= request.getParameter("user_name") %>" type="button" class="btn btn-primary col-4" style="margin-top: 30px; margin-bottom: 30px;">Volver a la lista de productos</a>
        </div>
 </div>
</main>
