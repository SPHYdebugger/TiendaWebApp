...
public class SearchProductServletUser extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            request.getRequestDispatcher("searchProductsUser.jsp?user_name=" + userName).forward(request, response);
